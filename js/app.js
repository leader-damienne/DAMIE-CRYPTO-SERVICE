(function () {
  ...
  function requireAuth(page) {
    ...
    /* Ne pas rediriger hors de l’URL ouverte par App Studio / Pi Browser */
  ...
  /**
   * Exigence Pi officielle (Common Mistakes / SDK) :
  ...
  function setupSignup() {
    if (isEcosystemMode()) {
      ...
      if (isLoggedIn()) {
        /* Ecosystem / App Studio : rester sur l’URL ouverte */
        return;
      }
