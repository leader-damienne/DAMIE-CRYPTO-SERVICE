...
(function (global) {
  ...
  var DICT = {
    fr: {
      ...
      "mod.profile.title": "Profil",
      "mod.profile.desc": "Profil Pioneer Pi, avatar et préférences.",
    ...
    en: {
      ...
      "mod.profile.title": "Profile",
      "mod.profile.desc": "Pi Pioneer profile, avatar and preferences.",
      "mod.academy.title": "DCS Academy",
    ...
    pt: {
      ...
      "mod.profile.title": "Perfil",
      "mod.profile.desc": "Perfil Pioneer Pi, avatar e preferências.",
      "mod.academy.title": "DCS Academy",
    ...
    ar: {
      ...
      "mod.profile.title": "الملف",
      "mod.profile.desc": "ملف Pioneer Pi والصورة والتفضيلات.",
      "mod.academy.title": "DCS Academy",
